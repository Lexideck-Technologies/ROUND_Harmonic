...
P(f"Batch UID: {UID}")
C={'task':'parity_16','input_dim':16,'hidden_size':32,'steps':20,'epochs':1000,'batch_size':64,'dataset_size':2000,'runs':5,'lr':0.005,'device':'cuda' if torch.cuda.is_available() else 'cpu'}
