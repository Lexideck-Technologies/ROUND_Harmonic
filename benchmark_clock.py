...
P(f"Batch UID: {UID}")
C={'task':'modulo_8','seq_len':20,'classes':8,'hidden_size':32,'steps':20,'epochs':1000,'batch_size':64,'dataset_size':4000,'runs':5,'lr':0.005,'device':'cuda' if torch.cuda.is_available() else 'cpu'}
